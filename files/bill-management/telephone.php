                            ...
                            <div class="page-header">
                                ...
                                <div style="float: right;">
                                    ...
                                    <!-- <div style="padding-left: 200px;">
                                        <button style="font-size: 20px; width: 180px;background-color: wheat"><i class="ti-plus"></i><a href="form_telephone.php"> ADD New Bill</a></button>
                                    </div> -->
                                    <div class="product-sidebar-widget" style="padding-left: 200px;">
                                    <a href="form_telephone.php" class="btn btn-primary"><i class="ti-plus"></i> Add New Bill</a>
                                </div>
                                </div>
                                <br><br>
