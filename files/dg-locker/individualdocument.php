...
<head>
    ...
    <!-- <script type="text/javascript" src="individualdocument.js"></script>
 -->
                ...
                <nav class="navbar navbar-expand-lg navbar-light">
                    ...
                    <div class="collapse navbar-collapse" id="navbarNav">
                        <ul class="navbar-nav flex-column">
                            ...
                            <li class="nav-item">
                                <a class="nav-link active" href="#" data-toggle="collapse" aria-expanded="false" data-target="#submenu-3" aria-controls="submenu-3"><i class="fas fa-fw fa-chart-pie"></i>DG Locker</a>
                                <div id="submenu-3" class="collapse submenu" >
                                    <ul class="nav flex-column">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" href="homedocument.html">Home document</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" href="shopdocument.html">Shop document</a>
                                        </li>
                                    </ul>
                                </div>
                            </li>
    ...
    <?php
            ...
            if(mysqli_num_rows($result)){
                while ($row=mysqli_fetch_array($result)) {
                    ...
                    $documenthideid="1234".$documentname;
                    
                    $str="<script>
                            $(document).ready(function(){
                                $(\"#inddoc\").append(\"<div class='col-xl-4 col-lg-6 col-md-12 col-sm-12 col-12' style='float:left; id='$documenthideid'>\
                              <div class='product-thumbnail'>\
                                  <div class='product-img-head'>\
                                    <div class='product-img'>\
                                    ...
                                    <div class='product-content'>\
                                        ...
                                        <div class='product-btn'>\
                                                <a href='$documentview' $viewprotected  id='$documentname' onClick='createsession(this.id)' class='btn btn-primary' style='width:45%;' disabled>View</a>\
